...
export async function migrate() {
  ...
  try {
    ...
    for (const file of ['001_security.sql', '002_google_sso.sql', '003_conversations.sql', '004_hardening.sql', '005_documents.sql', '006_okf.sql', '007_production.sql', '008_knowledge_queries.sql', '009_analytics.sql', '010_analytics_insights.sql', '011_feedback_corrections.sql', '012_token_usage_analytics.sql', '013_embedding_previews.sql']) {
